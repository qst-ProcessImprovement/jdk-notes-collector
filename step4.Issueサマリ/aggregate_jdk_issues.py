"""Aggregate JDK issue classifications for release note summaries.

This module builds on ``filter_jdk_issues`` to produce detail and summary
reports that support the 21.0.5 -> 21.0.8 compatibility review.
"""
